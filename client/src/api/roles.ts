...
export const getRoles = async () => {
  try {
    ...
    debugApiResponse(response.data, 'getRoles');

    // Extract roles array from nested structure
    return extractApiArray(response.data, 'roles');
  } catch (error: any) {
...
// Description: Get available permissions for roles
